...
class MinimalVideoSubscriber(Node):
    ...
    def _laser_callback(self, lidar_msg):
        ...
        ranges[(ranges < 0.1) | (ranges > 5)] = desired_dist  # also cap the max reliable distance to 10m
        ...
        if self._coordinates is not None:
            ...
            """ if (xL_angle == 0) and (xR_angle == 0): 
                ...
                self.get_logger().info("Left index: " + str(left_index))
                self.get_logger().info("Right index: " + str(right_index))
